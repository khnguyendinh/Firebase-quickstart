...
public class UIHandler : MonoBehaviour
{
    ...
    void InitializeFirebase() {
      ...
      app.SetEditorDatabaseUrl("https://photondemo-af253.firebaseio.com");
    ...
    void Start()
    {
        ...
        FirebaseApp.DefaultInstance.SetEditorDatabaseUrl("https://photondemo-af253.firebaseio.com");
        FirebaseApp.DefaultInstance.SetEditorP12FileName("PhotonDemo-3845e46a24c0.p12");
        FirebaseApp.DefaultInstance.SetEditorServiceAccountEmail("photondemo@photondemo-af253.iam.gserviceaccount.com");
        FirebaseApp.DefaultInstance.SetEditorP12Password("notasecret");
        reference = FirebaseDatabase.DefaultInstance.RootReference;
        //User user = new User("khoa1","khoas22@gmail");
        //writeNewUser("12011", "khoa11", "khoas21@gmail");
        //writeNewUser("12012", "khoa12", "khoas22@gmail");
        //WriteNewScore("12012", 2000);
        //WriteNewScore("12013", 2001);
        //reWriteUser("12012", "khoa1", "khoas2@gmail");
        //AddScoreToLeaders("khoas22@gmail", 2002, reference);
        readData();
    }
    ...
    private void reWriteUser(string userId, string name, string email)
    {
        ...
        Debug.Log("save done reWriteUser");
    }
      ...
      if (leaders == null) {
        ...
        if (minScore > score) {
          // The new score is lower than the existing 5 scores, abort.
            Debug.Log("diem thấp quá ko lưu nhé  ");
          return TransactionResult.Abort();
        }
    ...
    {
        FirebaseDatabase.DefaultInstance
  .GetReference("scores").Child("-K_T9tYh464V6MYeR7SS")
  .OrderByChild("uid").ValueChanged += (object sender, ValueChangedEventArgs args) =>
  {
      ...
      Debug.Log("value change "+args.Snapshot.Child("uid").ToString());
  };
    }
}
